...
saveRDS(list(par_results,highrisk_scalar_samples,neighbour_scalar_samples),'mit1e.Rds')
...
saveRDS(list(par_results,highrisk_scalar_samples,neighbour_scalar_samples),'mipower.Rds')
