...
for(eval_day in eval_days[2]){
  ...
  text(label=paste0('Sample size = ',round(maxss+minss)),x=(minss+maxss+300)/2,y=(minss+maxss-300)/2,srt=-45,cex=1.25,pos=3)
  for(i in 1:5){
    ss_tmp <- maxss - 100*i
  ...
  text(label='Fixed equal allocation',x=1750,y=1750,srt=45,cex=1.25,pos=3)
